...
const nextConfig: NextConfig = {
  ...
  serverExternalPackages: ["pdf-parse", "pdfjs-dist", "pngjs", "sql.js", "ankipack", "@open-spaced-repetition/binding", "mammoth", "jszip", "fzstd", "youtube-transcript", "tesseract.js"],
  ...
  experimental: {
    ...
    // Do not retain authenticated dynamic RSC payloads across account changes in
    // the browser Router Cache. Static routes can still use the longer cache.
    staleTimes: {
      dynamic: 0,
      static: 600,
    },
