...
import { getNotionConnection, notionConfigured, normalizeNotionWorkspaceIcon } from "@/lib/notion/client";
...
export const GET = withApiTiming(async function GET() {
  ...
  return NextResponse.json({
    ...
    workspaceIcon: normalizeNotionWorkspaceIcon(connection?.workspace_icon),
  });
